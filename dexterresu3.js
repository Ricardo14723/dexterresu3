...
<div class="download-container">
    ...
    <div class="series-header">
        ...
        <div class="series-info">
            <h1>Enlaces de Descarga - Dexter: Resurreccion</h1>
    ...
    <div class="tab-content active" id="season-1">
        <div class="season-info">
            ...
            <div class="season-specs">
                <div class="season-spec">
                    ...
                    <div class="spec-value">Latino AC3 5.1</div><div class="spec-value">Ingles EAC3 5.1</div></div><div class="season-spec"><div class="spec-label">FORMATO</div>
            ...
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        ...
                        <div class="episode-spec-value">3.14 GB</div>
                    </div>
                    <div class="episode-spec">
                ...
                <a class="download-button" href="https://tpi.li/d3xt3r1" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
       ...
       <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">3.80 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                ...
                <a class="download-button" href="https://tpi.li/d3xt3r4" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
        ...
        <!--    <div class="episode-card">
           ...
           <div class="episode-card">
            ...
            <div class="episode-card">
                ...
                <a class="download-button" href="https://tpi.li/M4T4B0t9" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>-->
